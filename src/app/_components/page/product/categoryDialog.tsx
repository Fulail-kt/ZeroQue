...
//       subcategories: initialData?.subcategories?.length 
...
//             <div key={form.getValues(`subcategories.${index}._id`) || index} className="grid grid-cols-3 gap-2 mb-2">
//               <FormField
//                 control={form.control}
...
//                 )}
//               />
//               {(form.getValues('subcategories')?.length || 0) > 1 && (
//                 <Button
//                   type="button"
//                   variant="destructive"
//                   size="icon"
