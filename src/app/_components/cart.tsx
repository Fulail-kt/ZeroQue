...
// // Improved Product and CartItem Types
...
//         <p className="text-muted-foreground">${item.sizes[0].price.toFixed(2)}</p>
//       </div>
//     </div>
...
//       total + item.sizes[0].price * item.quantity, 0);
//   };
...
//     console.log("hleoooooooooo")
//     // Any pre-checkout logic
//     if (cart.length > 0) {
...
//             )}
//           </div>
//           <button >HEosadfdajasljkfa</button>
